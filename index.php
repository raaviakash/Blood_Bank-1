    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <div class="fill" style="background-image:url('images/s1.jfif');"></div>
            ...
            <div class="item">
                <div class="fill" style="background-image:url('images/s3.png');"></div>
                <div class="carousel-caption">
    ...
    <div class="container">
			 ...
			 <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="request_blood.php" class="btn btn-primary">Request</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-user"></i>Happy Donors</h4>
                    </div>
                    <div class="panel-body">
                        <?php
                        include("config.php");
...
// $arrlength = count($row);
  ...
  echo "<p>0</p>";
			 ...
			 <div class="col-md-4">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-medkit"></i>Recepients</h4>
                    </div>
                    <div class="panel-body">
                    <?php
                        include("config.php");
			  ...
			  <div class="col-md-4">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        ...
                        <h4><i class="fa fa-heartbeat fa-lg"> </i> Success Smiles</h4>
                    </div>
                    <div class="panel-body">
                    <?php
                        include("config.php");
...
<!-- storage -->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header text-primary">
                   Details of Blood group
                </h1>
            </div>
            		 <div class="col-md-4">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-user"></i> Donors </h4>
                    </div>
                    <div class="panel-body">
                       <b> O+&nbsp; &nbsp; &nbsp; : &nbsp; &nbsp;</b>
                    <?php
                        ...
                        $sql = "SELECT * FROM blood_donor where BLOOD like 'O+'";
                        ...
                        echo "<p style='color:red;display:inline;'>$c</p>";
                        } else {
                        echo "<p style='color:red;display:inline;'>0</p>";
                        }
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM blood_donor where BLOOD like 'A+'";
                    ...
                    <b> B+&nbsp; &nbsp; &nbsp; : &nbsp; &nbsp;</b>
                     ...
                     <?php
                        ...
                        $sql = "SELECT * FROM blood_donor where BLOOD like 'B+'";
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM blood_donor where BLOOD like 'AB+'";
			 ...
			 <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM request_blood where BLOOD like 'O+'";
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM request_blood where BLOOD like 'A+'";
                    ...
                    <b> B+&nbsp; &nbsp; &nbsp; : &nbsp; &nbsp;</b>
                     ...
                     <?php
                        ...
                        $sql = "SELECT * FROM request_blood where BLOOD like 'B+'";
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM request_blood where BLOOD like 'AB+'";
...
<?php
      ...
      <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header  text-primary"><marquee direction="right" bgcolor=" cyan" color="black" scrolldelay="10s">Blood Donor Camps</marquee></h2>
            </div>
        ...
        <div class="row">
			...
			<ul>
				...
				<li>Around half our current donors are over 45. That's why we need more young people to start giving blood, so we can make sure we have enough blood in the future.</li>
